...
import { Smartphone, Cpu, Network, Database, Wrench, CheckCircle2 } from 'lucide-react';
...
export default function TechEcosystem({ lang }) {
  ...
  const categories = [
    { id: 'mobile', label: t.domains.mobile, icon: Smartphone, color: '#0071E3' },
    { id: 'architecture', label: t.domains.architecture, icon: Cpu, color: '#6E44FF' },
    { id: 'apiManagement', label: t.domains.apiManagement, icon: Network, color: '#FF6B00' },
    { id: 'backendData', label: t.domains.backendData, icon: Database, color: '#10B981' },
    { id: 'devops', label: t.domains.devops, icon: Wrench, color: '#64748B' }
  ];

  const currentItems = techData[activeCategory] || techData.mobile;

  return (
    <section id="tech" className="py-24 bg-slate-900 text-white relative">
