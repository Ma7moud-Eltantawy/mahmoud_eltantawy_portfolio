...
.eyebrow.amber::before{background:var(--accent-2);box-shadow:0 0 0 4px var(--accent-2-dim);}
...
#boot .cursor{display:inline-block;width:8px;height:14px;background:var(--accent);animation:blink 1s steps(2) infinite;vertical-align:middle;}
...
.logo{font-family:'IBM Plex Mono',monospace;font-weight:600;font-size:15px;letter-spacing:.02em;display:flex;align-items:center;gap:8px;}
...
.navsocial{display:flex;align-items:center;gap:16px;}
.icon-btn{
...
.navtime{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--text-faint);display:flex;align-items:center;gap:8px;}
.burger{display:none;flex-direction:column;gap:5px;cursor:pointer;width:24px;}
...
#mobilemenu{
  ...
  display:none;flex-direction:column;padding:40px 32px;gap:28px;
}
#mobilemenu.open{display:flex;}
#mobilemenu a{font-family:'Space Grotesk',sans-serif;font-size:24px;}
...
.hero-meta{display:flex;gap:28px;flex-wrap:wrap;font-family:'IBM Plex Mono',monospace;font-size:12.5px;color:var(--text-faint);}
...
/* ============================================================
   MARQUEE
============================================================ */
.marquee-wrap{border-bottom:1px solid var(--line-soft);background:var(--bg-1);overflow:hidden;padding:18px 0;}
...
.stat-num{font-family:'Space Grotesk',sans-serif;font-size:38px;font-weight:700;color:var(--accent);}
...
.avatar-badge{
  ...
  color:var(--accent);font-family:'IBM Plex Mono',monospace;font-size:10.5px;padding:6px 10px;
...
.lang-tag{font-family:'IBM Plex Mono',monospace;font-size:11.5px;border:1px solid var(--line);border-radius:7px;padding:7px 11px;color:var(--text-dim);}
...
.edu-line .t{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:15.5px;}
.edu-line .s{color:var(--text-dim);font-size:13.5px;margin-top:4px;}
.edu-line .d{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--text-faint);white-space:nowrap;}
...
.entry-id{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--accent);letter-spacing:.06em;}
.entry-role{font-family:'Space Grotesk',sans-serif;font-size:22px;font-weight:600;margin-top:6px;}
.entry-co{color:var(--text-dim);font-size:15px;margin-top:2px;}
.entry-co a{color:var(--accent);border-bottom:1px dotted var(--accent);}
.entry-meta{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--text-faint);text-align:right;white-space:nowrap;}
.entry-desc{color:var(--text-dim);font-size:15px;max-width:680px;margin-top:12px;}
.current-tag{background:var(--accent-dim);color:var(--accent);font-family:'IBM Plex Mono',monospace;font-size:10.5px;padding:3px 9px;border-radius:20px;margin-left:10px;}
...
.skill-name{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:15.5px;}
.skill-status{font-family:'IBM Plex Mono',monospace;font-size:9.5px;color:var(--accent);display:flex;align-items:center;gap:5px;letter-spacing:.05em;}
...
.proj-private{font-family:'IBM Plex Mono',monospace;font-size:9.5px;color:var(--text-faint);border:1px solid var(--line-soft);padding:6px 9px;border-radius:8px;white-space:nowrap;}
.proj-title{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:17.5px;margin-bottom:8px;}
...
.course-org{font-family:'IBM Plex Mono',monospace;font-size:12px;color:var(--text-faint);white-space:nowrap;}
...
.contact-title{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:clamp(30px,4.5vw,48px);position:relative;z-index:1;margin-bottom:18px;letter-spacing:-.01em;}
...
.contact-direct{display:flex;justify-content:center;gap:36px;flex-wrap:wrap;font-family:'IBM Plex Mono',monospace;font-size:13px;color:var(--text-dim);position:relative;z-index:1;}
...
<header>
  <nav>
    ...
    <div style="display:flex;align-items:center;gap:18px;">
      <div class="navtime"><span class="dot" style="width:6px;height:6px;border-radius:50%;background:var(--accent);"></span><span id="localtime">--:--</span> · Al&nbsp;Khobar</div>
      <div class="navsocial">
...
<section id="hero">
  ...
  <div class="wrap hero-grid">
    <div>
      <div class="eyebrow">// Flutter Engineer — Al&nbsp;Khobar, Saudi Arabia</div>
      <h1 class="hero-title">Mobile systems for<br>businesses that <span class="accent">can't&nbsp;afford<br>downtime.</span></h1>
      <p class="hero-line">I'm <b>Mahmoud Eltantawy</b>, a Flutter developer who builds offline-first POS, ERP and payment platforms — the kind that keep working when the WiFi at the till doesn't.</p>
      <div class="hero-ctas">
        <a href="#work" class="btn btn-primary">See the work<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M13 5l7 7-7 7"/></svg></a>
        <a href="https://wa.me/966575820045?text=Hi%20Mahmoud%2C%20I%20saw%20your%20portfolio%20and%20would%20like%20to%20talk%20about%20a%20Flutter%20project." target="_blank" rel="noopener" class="btn btn-ghost">Let's talk</a>
      </div>
      <div class="hero-meta">
        <span><span class="live"></span>Open to new roles</span>
        <span>📍 Al Khobar, KSA</span>
        <span>2.5+ yrs in production Flutter</span>
      </div>
    </div>
...
<div class="marquee-wrap">
  <div class="marquee" id="marquee">
    <span>FLUTTER &amp; DART<span class="sep">•</span>CLEAN ARCHITECTURE<span class="sep">•</span>REAL-TIME SOCKETS<span class="sep">•</span>FIREBASE<span class="sep">•</span>SQL SERVER<span class="sep">•</span>SUPABASE<span class="sep">•</span>REST APIs<span class="sep">•</span>GETX / BLOC / PROVIDER<span class="sep">•</span>CI/CD — SHOREBIRD<span class="sep">•</span>OFFLINE-FIRST SYNC<span class="sep">•</span></span>
    <span>FLUTTER &amp; DART<span class="sep">•</span>CLEAN ARCHITECTURE<span class="sep">•</span>REAL-TIME SOCKETS<span class="sep">•</span>FIREBASE<span class="sep">•</span>SQL SERVER<span class="sep">•</span>SUPABASE<span class="sep">•</span>REST APIs<span class="sep">•</span>GETX / BLOC / PROVIDER<span class="sep">•</span>CI/CD — SHOREBIRD<span class="sep">•</span>OFFLINE-FIRST SYNC<span class="sep">•</span></span>
  </div>
</div>
...
<section id="stats">
  <div class="wrap reveal">
    <div class="stat-cell"><div class="stat-num">2.5+</div><div class="stat-label">Years shipping Flutter in production</div></div>
    <div class="stat-cell"><div class="stat-num">10+</div><div class="stat-label">Apps shipped — POS, ERP, wallets, HR</div></div>
    <div class="stat-cell"><div class="stat-num">2</div><div class="stat-label">Countries — Egypt &amp; Saudi Arabia</div></div>
    <div class="stat-cell"><div class="stat-num">100%</div><div class="stat-label">Offline-first by default</div></div>
  </div>
</section>
    ...
    <div class="grid">
      <div class="reveal">
        <div class="avatar-wrap">
          ...
          <div class="avatar-badge"><span class="led"></span>Available</div>
        </div>
        <div class="about-langs">
          <span class="lang-tag"><b>Arabic</b> — Native</span>
          <span class="lang-tag"><b>English</b> — Professional</span>
        </div>
      </div>
      <div class="about-copy reveal">
        <h2 class="section-title">Two and a half years of making sure the app still works when the network doesn't.</h2>
        <p>I'm a Flutter developer based in <b>Al Khobar, Saudi Arabia</b>, originally from Egypt. Most of my work lives in the unglamorous, business-critical layer of mobile software: point-of-sale systems, multi-tenant ERPs, HR platforms, and payment apps that real cashiers, waiters, and accountants depend on every single day.</p>
        <p>I gravitate toward <b>clean architecture</b> and <b>offline-first design</b> — systems that keep functioning locally and reconcile automatically the moment connectivity comes back. I've built local POS engines wired directly to SQL Server, real-time order flows over WebSockets, and multi-tenant platforms where each client gets an isolated, customized experience.</p>
        <p>Outside of code, I'm constantly sharpening my English through daily practice, and I keep an entrepreneurial itch — I've sketched out plans for a logistics and shipping venture in Egypt on the side.</p>
        <div class="edu-line">
          <div>
            <div class="t">B.Sc. Computer Science</div>
            <div class="s">Misr Higher Institute for Engineering &amp; Technology (MET) — Mansoura, Egypt</div>
          </div>
          <div class="d">2018 — 2022 · Very Good</div>
        </div>
      </div>
    </div>
  </div>
...
<section id="experience">
  <div class="wrap">
    ...
    <h2 class="section-title reveal">Ledger of roles.</h2>
    <p class="section-sub reveal">Three entries, in order, each one a real production system handed to real businesses.</p>
      ...
      <div class="entry">
        <div class="entry-head">
          <div>
            ...
            <div class="entry-role">Mid-Level Software Engineer / Mobile App Developer<span class="current-tag">CURRENT</span></div>
            <div class="entry-co">Dolf Technologies</div>
          </div>
          <div class="entry-meta">Feb 2026 — Present</div>
        </div>
        <p class="entry-desc">Building and maintaining mobile applications as part of the engineering team, carrying the same clean-architecture and offline-first standards into a new codebase.</p>
      </div>
      ...
      <div class="entry">
        <div class="entry-head">
          <div>
            ...
            <div class="entry-role">Mid-Level Flutter Developer</div>
            <div class="entry-co"><a href="https://tebalink.com/" target="_blank" rel="noopener">Teba-link</a> — accounting &amp; administrative software</div>
          </div>
          <div class="entry-meta">Feb 2024 — Jan 2026<br>Giza, Egypt</div>
        </div>
        <p class="entry-desc">Enhanced and expanded a multi-tenant ERP system (Ezee Manager Pro / Tebalink ERP) used by multiple independent businesses on one platform. Built printing &amp; PDF modules, new financial reports, and reworked invoice calculations — plus a from-scratch local POS for restaurants wired directly to SQL Server, and a Flutter-based HR system with QR check-in.</p>
      </div>
      ...
      <div class="entry">
        <div class="entry-head">
          <div>
            ...
            <div class="entry-role">Flutter Developer</div>
            <div class="entry-co"><a href="https://www.darsaaed.com/ar" target="_blank" rel="noopener">Dar Alsaaed</a> — payments &amp; POS solutions</div>
          </div>
          <div class="entry-meta">Dec 2023 — Jun 2024<br>Riyadh, Saudi Arabia</div>
        </div>
        <p class="entry-desc">Helped move a fintech app (Saaed Pay) from native to a fully cross-platform Flutter build — NFC payments, wallet management, transfers, and AR/EN support. Also owned the order-management module of Saaed POS, syncing orders over WebSocket for instant invoice generation.</p>
      </div>
    </div>
  </div>
</section>
...
<section id="skills">
  <div class="wrap">
    <div class="eyebrow reveal">03 — Skills</div>
    <h2 class="section-title reveal">What's running under the hood.</h2>
    <p class="section-sub reveal">Grouped the way I'd actually structure a project — not just a tag cloud.</p>

    <div class="skills-grid reveal">
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">Mobile Development</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
        <div class="skill-tags"><span>Dart</span><span>Flutter</span><span>GetX</span><span>Bloc</span><span>Provider</span></div>
      </div>
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">Architecture &amp; Design</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
        <div class="skill-tags"><span>Clean Architecture</span><span>SOLID</span><span>System Diagrams</span></div>
      </div>
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">Data &amp; Sync</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
      ...
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">Backend &amp; Languages</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
        <div class="skill-tags"><span>Node.js</span><span>Java</span><span>C++</span><span>JavaScript</span><span>OOP</span></div>
      </div>
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">DevOps &amp; Delivery</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
      ...
      <div class="skill-card">
        <div class="skill-head"><span class="skill-name">Process &amp; Quality</span><span class="skill-status"><span class="led"></span>ONLINE</span></div>
...
<section id="work">
  <div class="wrap">
    <div class="eyebrow reveal">04 — Selected Work</div>
    <h2 class="section-title reveal">Ten systems, shipped to real businesses.</h2>
    <p class="section-sub reveal">From a graduation project teaching literacy, to wallets moving real money.</p>
    ...
    <div class="proj-grid reveal">
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">Offline-and-online ERP serving multiple isolated businesses on one platform, with automatic sync, custom print/PDF modules, and reworked financial reporting.</p>
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">A full local POS built from scratch, talking directly to SQL Server with no API layer — live sync between kitchen, cashier and waiter stations.</p>
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">Fintech wallet app rebuilt cross-platform in Flutter: NFC payments, wallet top-ups, transfers and bill payments with full AR/EN support.</p>
        <div class="proj-tags"><span>Flutter</span><span>NFC</span><span>Fintech</span></div>
      </div>

      <div class="proj-card">
        <div class="proj-top"><div class="proj-glyph">POS</div>
          <span class="proj-private">Private build</span>
        </div>
        <div class="proj-title">Saaed POS — Order Management</div>
        <p class="proj-desc">Owned the order-management module: REST for product data, WebSocket for live order updates, with instant invoice generation on quantity changes.</p>
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">Migrated a men's fashion &amp; tailoring retail app from native to cross-platform Flutter — first phase of performance and UI groundwork.</p>
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">HR management app built from scratch — QR-based attendance, role-based permissions, leave requests and reporting, with RESTful sync.</p>
      ...
      <div class="proj-card">
        ...
        <p class="proj-desc">An e-commerce app with Google Maps, conversational voice AI, Firebase push notifications and Gmail verification baked in.</p>
      ...
      <div class="proj-card">
        ...
        <div class="proj-title">Illuminate (Graduation Project)</div>
        <p class="proj-desc">A literacy platform pairing volunteer teachers with adult learners — separate teacher and student apps for structured, interactive lessons.</p>
      ...
      <div class="proj-card">
        ...
        <div class="proj-title">E-commerce Multi-Tenant Platform</div>
        <p class="proj-desc">Each vendor gets a fully customized storefront and a private dashboard for products, orders and layout — with secure payments and bilingual UI.</p>
        <div class="proj-tags"><span>Flutter</span><span>Multi-tenant</span></div>
      </div>

      <div class="proj-card">
        <div class="proj-top"><div class="proj-glyph">PRT</div>
          <span class="proj-private">In development</span>
        </div>
        <div class="proj-title">Ezze Customer</div>
        <p class="proj-desc">A client-facing portal giving end-users of client companies real-time access to financial statements and live inventory data.</p>
...
<section id="courses">
  <div class="wrap">
    <div class="eyebrow reveal">05 — Courses &amp; Certifications</div>
    <h2 class="section-title reveal">Still compiling.</h2>
    <p class="section-sub reveal">Formal learning that backs up the production experience.</p>
...
<section id="contact">
  <div class="wrap">
    <div class="contact-box reveal">
      <h2 class="contact-title">Got a system that<br>needs <span class="accent">building?</span></h2>
      <p class="contact-sub">I'm currently open to new Flutter roles and freelance builds — POS, ERP, fintech, or anything that needs to survive a bad connection.</p>
      <div class="contact-ctas">
        ...
        <a href="mailto:mahmoudeltantawy2019@gmail.com" class="btn btn-ghost">Send an email</a>
      </div>
...
<footer>
  <div class="wrap footer-row">
    <span class="mono">© 2026 Mahmoud Eltantawy — built one offline sync at a time.</span>
  ...
  function step(now){
    ...
    for(let i=0;i<nodes.length;i++){
      ...
      for(let k=0;k<2;k++){
        ...
        ctx.strokeStyle = dim ? 'rgba(140,150,165,0.06)' : 'rgba(0,230,160,0.10)';
    ...
    nodes.forEach(n=>{
      ...
      ctx.fillStyle = n.offline ? 'rgba(140,150,165,0.5)' : `rgba(0,230,160,${0.5+glow*0.5})`;
      ctx.fill();
      if(!n.offline){
        ctx.beginPath();
        ctx.arc(n.x,n.y,n.r+3*devicePixelRatio*glow,0,Math.PI*2);
        ctx.strokeStyle = `rgba(0,230,160,${0.25*glow})`;
        ctx.stroke();
      }
    });
